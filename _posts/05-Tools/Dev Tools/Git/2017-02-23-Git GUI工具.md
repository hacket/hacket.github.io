...
date_updated: Thursday, January 30th 2025, 1:33:28 pm
title: Git GUI工具
author: hacket
categories:
  - Tools
...
**Unstaged files**<br>未 git add 文件状态<br>**Staged files**<br>git add 后文件状态<br>此时的文件还是处于本地分支, 远端还没有, 直接选中要回滚的文件右键 Discard 丢弃掉<br>![w29zz](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/w29zz.png)
