...
date_updated: Saturday, September 6th 2025, 12:49:55 am
title: 03 Python字符串
author: hacket
categories:
  - Python
...
申明了 UTF-8 编码并不意味着你的.py 文件就是 UTF-8 编码的，必须并且要确保文本编辑器正在使用 `UTF-8 without BOM` 编码：<br>![i4ggq](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/i4ggq.png)<br>如果.py 文件本身使用 `UTF-8` 编码保存，并且也申明了 `# -*- coding: utf-8 -*-`，打开命令提示符测试就可以正常显示中文：
