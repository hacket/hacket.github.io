...
date_updated: Friday, January 31st 2025, 6:41:43 pm
title: Kotlin面向对象
author: hacket
categories:
  - Java&Kotlin
...
匿名对象只有定义成局部变量和 private 成员变量时，才能体现它的真实类型。如果你是将匿名对象作为 public 函数的返回值或者是 public 属性时，你只能将它看做是它的父类，当然你不指定任何类型时就当做 Any 看待。这时，你在匿名对象中添加的属性和方法是不能够被访问的。<br>![8c5k5](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/8c5k5.png)
