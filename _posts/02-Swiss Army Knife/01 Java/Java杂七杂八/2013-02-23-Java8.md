...
date_updated: Thursday, January 30th 2025, 6:15:53 pm
title: Java8
author: hacket
categories:
  - Java&Kotlin
...
![5sbrr](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/5sbrr.png)
...
编译生成 1 个 class 文件：<br>![0pyb0](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/0pyb0.png)
...
就会 dump 出运行时中间生成的 lambda 类<br>
![aur7m](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/aur7m.png)
...
DateTimeFormatter 类用于将字符串解析为日期对象<br>![4vbb3](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/4vbb3.png)<br>Java8 新增的 `DateTimeFormatter` 与 `SimpleDateFormat` 最大区别是:Java8 的 DateTimeFormatter 是线程安全的，而 SimpleDateFormat 不是线程安全。
