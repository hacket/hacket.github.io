...
date_updated: Friday, January 31st 2025, 10:22:04 pm
title: 04 数组
author: hacket
categories:
  - 数据结构和算法
...
> ![erzsz](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/erzsz.png)
...
考虑如下数组：<br />![xvm98](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/xvm98.png)
...
**双指针优化版本**<br />如果要移除的元素恰好在数组的开头，例如序列 `[1,2,3,4,5]`，当 _val=1_ 时，我们需要把每一个元素都左移一位。实际上我们可以直接将最后一个元素 5 移动到序列开头，取代元素 1，得到序列 `[5,2,3,4]`，同样满足题目要求。这个优化在序列中 val 元素的数量较少时非常有效。<br />
**思路**
...
![66tmb](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/66tmb.png)
...
> ![bqz9o](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/bqz9o.png)
...
2. 首先需要将 matrix 计算二维前缀和存储到 preSum 二维数组中去，其实就是计算几块区域之和
   ...
   3. ![w7rsv](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/w7rsv.png)
3. sumRegion 计算子矩阵之和
   1. S(A,D)=S(O,D)−S(O,E)−S(O,F)+S(O,G) // S(O,G) 被多减去了一次，需要加回来
   2. ![aagp8](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/aagp8.png)
...
![o65d9](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/o65d9.png)
...
![ejuhq](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/ejuhq.png)<br />时间复杂度：O(n^2) 排序 O(nlogn)，两层循环
...
![amz2d](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/amz2d.png)
...
**复杂度**<br />
时间复杂度：O(2n^2)，即 O(n^2)<br />
空间复杂度：O(n^2)，多了个临时的矩阵

#### 解法 2：拆解成主对对角对称 + 左右旋转 最优解

[旋转图像 | 操作分解 | 超简洁易懂的代码 【c++/java详细题解】](https://leetcode.cn/problems/rotate-image/solution/48-xuan-zhuan-tu-xiang-chao-jian-ji-yi-d-nuau/)<br />
...
> ![xzott](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/xzott.png)
...
![jmtx2](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/jmtx2.png)

3. 随着螺旋遍历，相应的边界会收缩，直到螺旋遍历完整个数组：

![ef3g0](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/ef3g0.png)<br />**代码**
...
> ![b1a5n](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/b1a5n.png)
> 输入：n = 3
...
![arelc](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/arelc.png)<br />
...
![c4ph2](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/c4ph2.png)<br />
...
![3wvuw](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/3wvuw.png)<br />**代码：**
...
![feux8](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/feux8.png)
...
![kr2yf](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/kr2yf.png)
