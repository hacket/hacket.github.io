...
date_updated: Friday, February 21st 2025, 12:07:22 am
title: Uri（URL）
author: hacket
categories:
  - 计算机基础
...
![2plpw](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/2plpw.png)<br>需要转码的字符：
...
支持 `xxxlink://applink/pushtoweb2?data={"url":"https://api-xxx.xxx.com/h5/game/happy-flip/happy-flip2-us5test/invitation?abc=123"}`

- Data 里有 url，url 有 2 个参数，data 后的数据都是没有 URL Encode

不支持 `xxxlink://applink/pushtoweb2?data={"url":"https://api-xxx.xxx.com/h5/game/happy-flip/happy-flip2-us5test/invitation?abc=123&hacket=456"}`

- 对 data 后的 url 整体编码

支持 `xxxlink://applink/pushtoweb2?data={"url":"https%3A%2F%2Fapi-xxx.xxx.com%2Fh5%2Fgame%2Fhappy-flip%2Fhappy-flip2-us5test%2Finvitation%3Fabc%3D123%26hacket%3D456"}`

- 对 url 后的多个参数编码，编码第 1 个参数=后及后面的参数的部分，1 个参数的不用编码也支持

支持 `xxxlink://applink/pushtoweb2?data={"url":"https://api-xxx.xxx.com/h5/game/happy-flip/happy-flip2-us5test/invitation?abc%3D123%26hacket%3D456"}`
