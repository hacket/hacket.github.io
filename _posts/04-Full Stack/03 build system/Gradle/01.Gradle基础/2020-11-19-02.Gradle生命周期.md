...
date_updated: Saturday, February 1st 2025, 12:02:40 am
title: 02.Gradle生命周期
author: hacket
categories:
  - Android
...
![b5ooe](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/b5ooe.png)

![kt51h](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/kt51h.png)<br> Gradle 的执行分为三大阶段: `Initialization` -> `Configuration` -> `Execution`
...
Gradle 默认为我们配置了一个 key 为 `ext` 的特殊值, 称为**额外属性**. 额外属性也是一个类似 Map 的结构:<br>![m80wf](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/m80wf.png)<br>额外属性最常见的场景是在一个构建过程中定义公共的变量, 例如: 在多模块构建中统一依赖的版本:
