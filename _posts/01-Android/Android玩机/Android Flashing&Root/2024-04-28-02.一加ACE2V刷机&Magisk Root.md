...
date_updated: Tuesday, November 11th 2025, 12:18:26 am
...
```shell
adb pull /sdcard/Download/magisk_patched-30100_QGedb.img .
```
...
- 如果 waiting for any device ，就是 usb 驱动需要更新 (安装 Android ADB Interface 驱动，可以用驱动人生)
