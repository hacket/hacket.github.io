...
date_updated: Wednesday, January 29th 2025, 6:55:07 pm
title: ARouter用法小结
author: hacket
categories:
  - Android进阶
...
![ymumn](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/ymumn.png)
...
![r6641](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/r6641.png)

- Google Module

![p6txu](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/p6txu.png)

- OpenSourceDemos

![xy4eo](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/xy4eo.png)<br />

**错误堆栈：** <br />![4ih2v](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/4ih2v.png)<br />类 `com.alibaba.android.arouter.routes.ARouter$$Group$$my_route` 定义了多次<br />

**问题分析：** <br />
kapt 对每个 module 的 `@Route` 解析生成 `com.alibaba.android.arouter.routes.ARouter$$Group$$group` 类，如果多个 module 中定义了相同的 group，那么就会出现不同的 module 中生成的类是一样，就会报 type define multi times 的编译错误<br />

**解决方案：**<br />
不同的 module 用不同的 group
...
![zolnw](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/zolnw.png)
