...
date_updated: Wednesday, January 29th 2025, 6:58:38 pm
title: Arouter原理
author: hacket
categories:
  - Android进阶
...
![t6qv2](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/t6qv2.png)
...
![ez7ib](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/ez7ib.png)

2. @Interceptor 生成拦截器信息

![s6jij](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/s6jij.png)

3. @Autowired 依赖注入使用，类似于 ButterKnife 的 @Bind

![od7ix](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/od7ix.png)
...
![wm9px](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/wm9px.png)
...
1. 找出 `com.alibaba.android.arouter.routes` 包下面所有的类名（这些是通过 apt 生成的），存到集合中。通过两种方式来获取，一种是在运行期间动态的遍历所有 dex 文件，另外一种是通过编译期间自定义插件通过 ASM 的方式把符合预期的类信息插入注册代码到 loadRouterMap 中。<br />
2. ![x8w2g](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/x8w2g.png)
...
![4vpvg](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/4vpvg.png)
