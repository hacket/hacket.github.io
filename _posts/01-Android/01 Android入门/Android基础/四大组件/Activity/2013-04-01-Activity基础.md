...
date_updated: Sunday, January 26th 2025, 12:06:56 am
title: Activity基础
author: hacket
categories:
  - Android
...
![qz0ft](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202501260006552.png)
...
![jw5os](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202501260006564.png)

2. 从 BActivity 返回到 AActivity

![6vykb](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202501260006566.png)<br />![gf6px](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202501260006567.jpg)
...
![yf3aw](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202501260006568.png)<br />解决：
...
![whe6g](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202501260006569.jpg)<br />系统提供了两种方式来设置一个 Activity 的启动模式，除了在 `AndroidManifest` 文件中设置以外，还可以通过 `Intent的Flag` 来设置一个 Activity 的启动模式。

### standard

标准的，默认的启动模式。<br />谁启动了这个 Activity，这个 Activity 就运行在启动它的那个 Activity 所在的栈中（用 Context 启动 Activity 会报错，因为 Context 没有任务栈，需要为待启动的 Activity 加上 `FLAG_ACTIVITY_NEW_TASK` 标记位，这样启动的时候就会为它创建一个新的任务栈，这个时候待启动 Activity 实际上是以 singleTask 启动的）<br />默认模式，可以不用写配置。在这个模式下，都会默认创建一个新的实例。因此，在这种模式下，可以有多个相同的实例，也允许多个相同 Activity 叠加。应用场景：绝大多数 Activity。<br />![8ea70](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202501260006570.png)
