...
date_updated: Monday, January 27th 2025, 1:06:25 am
title: 常用布局
author: hacket
categories:
  - AndroidUI
...
![56p0o](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202501261941820.png)<br />

- 第一个 textview：<br />`0+1080*(1/5) = 1080*(1/5)`<br />
- 第二、三个 textview:<br />`0+1080*(2/5) = 1080*(2/5)`
...
![bgr2e](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202501261941822.png)<br />

- 剩余空间：`1080-3*10180 = -2*1080`<br />
- 第一个 textview: `1080+(-2*1080)*(1/5) = 1080*(3/5)`<br />
- 第二、三个 textview: `1080+(-2*1080)*(2/5) = 1080*(1/5)`
...
![image.png](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202501261943872.png)
...
1. android:layout_toLeftOf="@id/safe_textview"   该组件的右边和指定组件的左边对齐，默认在 Top 位置![ud9ve](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202501261941824.png)
2. android:layout_alignLeft="@id/safe_textview" 该组件的左边和指定组件的左边对齐，默认在父组件的 top 位置 ![kb35i](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202501261941825.png)
...
### ProgressBar 不能在 Button 上面显示

![wdcaw](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202501261941826.png)

- 原因<br />Android 5.0 之后，Button 默认有 Z 轴方向的位移。
- 解决方法：`android:translationZ="2dp"`<br />![3mrz7](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202501261941827.png)
