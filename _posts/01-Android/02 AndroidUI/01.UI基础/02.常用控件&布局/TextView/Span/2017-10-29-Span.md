...
date_updated: Tuesday, March 18th 2025, 8:54:26 am
title: Span
author: hacket
categories:
  - AndroidUI
...
![202501210026114](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202503161004748.png)
...
![202501210026115](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202503161004759.png)
...
![202501210026116](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202503161004760.png)
...
![202501210026117](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202503161004761.png)
...
![202501210026118](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202503161004762.png)
...
![202501210026119](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202503161004763.png)
...
用途：一个 TextView 不同的字体大小<br>![202501210026121](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202503161004764.png)
...
![202501210026122](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202503161004766.png)<br>注意：设置文本,调用的时候不要调用 `android.widget.TextView#setText(CharSequence)}` 方法 而是调用 `setTagText(text)` 方法，不然没有效果。比如 setTagText("hello") 输出效果为加上前置文本和后置文本：`<前置文本>hello<后置文本>`。
...
2. 需要设置 LinkMovementMethod 才可以点击 `TextView.setMovementMethod(LinkMovementMethod.getInstance());`
3. 设置链接颜色、点击后没有背景、没有下划线
...
object : ClickableSpan() {
	override fun updateDrawState(ds: TextPaint) {
		...
		ds.isUnderlineText = false; // 移除下划线（可选）
		ds.linkColor = Color.RED // 设置点击时的颜色
		ds.bgColor = Color.TRANSPARENT // 移除背景高亮
	}

	override fun onClick(widget: View) {

		Toast.makeText(
			this@XXXSpanTestActivity,
			"click span 50% :$widget",
			Toast.LENGTH_SHORT
		).show()
	}
}
...
![202501210026123](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202503161004767.png)
