...
date_updated: Monday, January 27th 2025, 1:13:15 am
...
- UI 事件分发只是整个事件分发的一小部分<br /> ![teyg4](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202501270112435.png)
- UI 触摸事件整体事件分发流程
...
![pif7v](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202501270112436.png)
...
![b0b3y](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202501270112437.png)
...
如果顶层的 viewGroup 不是 DecorView，那么对调用对应 view 的 dispatchTouchEvent 方法进行分发。例如，顶层的 view 是一个 Button，那么会直接调用 Button 的 dispatchTouchEvent 方法；如果顶层 viewGroup 子类没有重写 dispatchTouchEvent 方法，那么会直接调用 ViewGroup 默认的 dispatchTouchEvent 方法。<br />![v2xip](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202501270112438.png)
...
![vrx6e](https://raw.githubusercontent.com/hacket/ObsidianOSS/master/obsidian/202501270112439.png)
