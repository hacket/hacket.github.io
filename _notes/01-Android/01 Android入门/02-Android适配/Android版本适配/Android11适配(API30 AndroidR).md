---
date created: 2024-04-11 21:47
tags:
  - '#query接口查找出来对应文件的Uri'
  - '#getNetworkType未给READ_PHONE_STATE部分手机崩溃'
date updated: 2024-12-24 21:54
dg-publish: true
---
...
![image.png|400](https://cdn.nlark.com/yuque/0/2023/png/694278/1687784928699-4036e7c5-d77d-4b7d-9866-bb79e7047a77.png#averageHue=%23f8f8f8&clientId=uc4a2b268-dea0-4&from=paste&height=154&id=u075f3b5b&originHeight=308&originWidth=361&originalType=binary&ratio=2&rotation=0&showTitle=false&size=46730&status=done&style=none&taskId=u05058c25-18ed-49db-9ba4-68b2f6e97c8&title=&width=180.5)
...
![image.png|400](https://cdn.nlark.com/yuque/0/2023/png/694278/1687784950029-39011949-167e-4e75-b27e-5d79584792d4.png#averageHue=%23f3f3f3&clientId=uc4a2b268-dea0-4&from=paste&height=142&id=u7a77f29f&originHeight=283&originWidth=326&originalType=binary&ratio=2&rotation=0&showTitle=false&size=33811&status=done&style=none&taskId=u689a63c2-dbe0-406a-a559-3f2d4b8b1ba&title=&width=163)

#### Android 11 设备，targetSdkVersion小于等于29 (Android 10), 申请前台和后台位置权限同时申请（弹窗无无始终允许按钮，提供到设置页设置始终允许）

```kotlin
requestPermissions(arrayOf(Manifest.permission.ACCESS_COARSE_LOCATION, Manifest.permission.ACCESS_BACKGROUND_LOCATION), 100)
```

![image.png|400](https://cdn.nlark.com/yuque/0/2023/png/694278/1687784958032-9c4d49b7-3c99-4940-8a8c-369afd3ece27.png#averageHue=%23f2f2f2&clientId=uc4a2b268-dea0-4&from=paste&height=170&id=u4d5788a5&originHeight=339&originWidth=322&originalType=binary&ratio=2&rotation=0&showTitle=false&size=53744&status=done&style=none&taskId=u555a4305-9fe8-4a6c-9925-df3f8f593f4&title=&width=161)

#### Android 11 设备，targetSdkVersion大于等于30 (Android 11), 申请前台和后台位置权限同时申请（无反应）
...
![image.png](https://cdn.nlark.com/yuque/0/2023/png/694278/1687784979838-9e23b1e2-e24e-45e2-a17e-752646637e63.png#averageHue=%23f3f3f3&clientId=uc4a2b268-dea0-4&from=paste&height=141&id=u0796aaf6&originHeight=282&originWidth=326&originalType=binary&ratio=2&rotation=0&showTitle=false&size=34191&status=done&style=none&taskId=uff8ba07f-11d1-4e6e-a2b5-824874d403c&title=&width=163)<br>2. 后申请后台位置权限，执行效果 (直接跳转到设置页面，无任何说明)：

```kotlin
requestPermissions(arrayOf(Manifest.permission.ACCESS_BACKGROUND_LOCATION), 100)
```

![image.png](https://cdn.nlark.com/yuque/0/2023/png/694278/1687784989744-1f180c97-766b-4f51-a2f7-c8da70ee12c7.png#averageHue=%23fbfbfb&clientId=uc4a2b268-dea0-4&from=paste&height=326&id=u989ab3e3&originHeight=652&originWidth=361&originalType=binary&ratio=2&rotation=0&showTitle=false&size=74964&status=done&style=none&taskId=u8846260d-c631-470f-b6a2-c1ab434802c&title=&width=180.5)
...
在 Android 11 中，每当应用请求与 `位置信息`、`麦克风` 或 `摄像头` 相关的权限时，面向用户的权限对话框会包含仅限这一次选项。如果用户在对话框中选择此选项，系统会自动提供一个单次授权的选项，只供这一次权限获取。然后用户下次打开 app 的时候，系统会再次提示用户授予权限。<br>![image.png](https://cdn.nlark.com/yuque/0/2023/png/694278/1687785025149-7d90084c-3408-4e9c-8687-1d60b7b78594.png#averageHue=%23f6f6f6&clientId=uc4a2b268-dea0-4&from=paste&height=140&id=u6b519802&originHeight=279&originWidth=316&originalType=binary&ratio=2&rotation=0&showTitle=false&size=32612&status=done&style=none&taskId=u4f101b5a-8e99-417d-a5e9-16b3b18bd43&title=&width=158)
...
1. RequestLegacyExternalStorage=true，让 targetSdkVersion 是 29（适配了 Android 10）的 App 无论是新安装还是覆盖安装，在 Android 10 系统上也继续访问旧的存储模型，requestLegacyExternalStorage 在 Android 11上的手机失效。
...
![image.png](https://cdn.nlark.com/yuque/0/2023/png/694278/1687785366304-173b2301-636a-4a70-bbf6-672759293a3b.png#averageHue=%2338677a&clientId=uc4a2b268-dea0-4&from=paste&height=506&id=u63382929&originHeight=1012&originWidth=1218&originalType=binary&ratio=2&rotation=0&showTitle=false&size=302839&status=done&style=none&taskId=u014ab12d-6eb2-48c2-8424-cf04432fd90&title=&width=609)
...
- Android Q 之前存储<br>![image.png](https://cdn.nlark.com/yuque/0/2023/png/694278/1687785472602-d8ce5e95-83f9-4950-a96e-af9431a54eda.png#averageHue=%23f1efec&clientId=uc4a2b268-dea0-4&from=paste&height=200&id=u8315cc10&originHeight=400&originWidth=832&originalType=binary&ratio=2&rotation=0&showTitle=false&size=113260&status=done&style=none&taskId=uc22f7c4d-b22d-4843-b847-db15a0951b7&title=&width=416)
- Android Q 及以上<br>![image.png](https://cdn.nlark.com/yuque/0/2023/png/694278/1687785488606-b0baf80d-df82-4191-9b91-071625034a48.png#averageHue=%23f0edeb&clientId=uc4a2b268-dea0-4&from=paste&height=199&id=u3afceb10&originHeight=398&originWidth=832&originalType=binary&ratio=2&rotation=0&showTitle=false&size=150380&status=done&style=none&taskId=ubbe2f3c5-1144-4a6d-9a5b-bdc0338d333&title=&width=416)

> 分区存储对 `内部存储私有目录` 和 `外部存储私有目录` 都没有影响，只对外部存储公共目录有影响

- 受影响的接口：<br>![image.png](https://cdn.nlark.com/yuque/0/2023/png/694278/1687785502174-834f7df1-f9db-4fc3-96fc-0bb3e719ec14.png#averageHue=%239ebece&clientId=uc4a2b268-dea0-4&from=paste&height=519&id=ufc312f25&originHeight=1038&originWidth=1936&originalType=binary&ratio=2&rotation=0&showTitle=false&size=911948&status=done&style=none&taskId=u0249dfd4-6d24-4df9-a868-ae696b445e1&title=&width=968)
- 不需要适配
  1. 私有目录（外部和内部存储）
  2. 内部存储
...
![image.png](https://cdn.nlark.com/yuque/0/2023/png/694278/1687785550822-99e439e7-98d3-4c48-8af7-0db1dde73d1b.png#averageHue=%23eff2f0&clientId=uc4a2b268-dea0-4&from=paste&height=230&id=ub4261f2d&originHeight=459&originWidth=1080&originalType=binary&ratio=2&rotation=0&showTitle=false&size=223573&status=done&style=none&taskId=u8864886a-096a-45ed-92d5-2019131af0b&title=&width=540)<br>开启了分区存储后，使用 File 访问外部公共目录会报下面异常
...
![image.png](https://cdn.nlark.com/yuque/0/2023/png/694278/1687785571952-44e1b63a-ba53-4466-9e98-dba1b3f980c9.png#averageHue=%23f6f5f4&clientId=uc4a2b268-dea0-4&from=paste&height=632&id=u039023a7&originHeight=1264&originWidth=928&originalType=binary&ratio=2&rotation=0&showTitle=false&size=183652&status=done&style=none&taskId=u654ee8a4-ad98-4129-89c5-a310196fb57&title=&width=464)
...
![image.png](https://cdn.nlark.com/yuque/0/2023/png/694278/1687785589518-4381e186-760f-4c80-a7fd-b61322a9f148.png#averageHue=%2342382e&clientId=uc4a2b268-dea0-4&from=paste&height=37&id=u97ac6a5a&originHeight=74&originWidth=762&originalType=binary&ratio=2&rotation=0&showTitle=false&size=43131&status=done&style=none&taskId=u460c9964-3e95-4784-a6b3-28c9ed52082&title=&width=381)
...
通过 ContentResolver，根据不同的 Uri 查询不同的内容：<br>![](http://note.youdao.com/yws/res/61289/72BD6594676340FCBFD8D5068579B335#id=rc6PG&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=) ![image.png](https://cdn.nlark.com/yuque/0/2023/png/694278/1687785606238-645d5fb9-e798-4062-832c-88985a8fb41f.png#averageHue=%232f2e2d&clientId=uc4a2b268-dea0-4&from=paste&height=126&id=u30be5a9e&originHeight=252&originWidth=686&originalType=binary&ratio=2&rotation=0&showTitle=false&size=107607&status=done&style=none&taskId=u90f6ae6b-1c6a-4431-b411-72dff072388&title=&width=343)
...
4. App 需要负责通过 close 接口关闭 FD<br>![image.png](https://cdn.nlark.com/yuque/0/2023/png/694278/1687785861291-41ccadcd-a521-4b7a-8c9b-8731601255ac.png#averageHue=%232f3849&clientId=uc4a2b268-dea0-4&from=paste&height=73&id=u4ae607e6&originHeight=146&originWidth=792&originalType=binary&ratio=2&rotation=0&showTitle=false&size=89183&status=done&style=none&taskId=u6c2adb57-a040-43a0-aacd-b6f2ea00c0c&title=&width=396)

##### 新建文件

如果需要新建文件存放到公共目录，需要通过 `ContentResolver#insert` 接口，使用不同的 Uri，选择存储到不同的目录。<br>![image.png](https://cdn.nlark.com/yuque/0/2023/png/694278/1687785881600-b1c8bfad-63d0-4f0a-b827-7b544b3ccc74.png#averageHue=%23403a30&clientId=uc4a2b268-dea0-4&from=paste&height=374&id=ubce17a80&originHeight=748&originWidth=762&originalType=binary&ratio=2&rotation=0&showTitle=false&size=376549&status=done&style=none&taskId=u79a54ec4-6948-4daf-82dc-b920be51fab&title=&width=381)

##### 修改文件

如果需要修改多媒体文件，需要通过 ContentResolver #query接口查找出来对应文件的Uri 。如果不是自己 App 新建的文件需要申请 `WRITE_EXTERNAL_STORAGE` 权限或者 catch RecoverableSecurityException，弹框给用户选择。<br>![image.png](https://cdn.nlark.com/yuque/0/2023/png/694278/1687785893274-c92cc408-8da7-4248-9436-732fa871c2fc.png#averageHue=%232f2e2e&clientId=uc4a2b268-dea0-4&from=paste&height=110&id=u9a6c69b2&originHeight=220&originWidth=832&originalType=binary&ratio=2&rotation=0&showTitle=false&size=92026&status=done&style=none&taskId=u07a7ff44-0695-4a3b-9783-45b51b775e9&title=&width=416) ![](http://note.youdao.com/yws/res/61320/9E88F6F740284F9CB26C553680D6EB6E#id=kyVSQ&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)<br>通过下列接口，获取需要修改文件的 FD 或者 OutputStream：
...
Android Q 上，MediaStore 中添加了一个 IS_PENDING Flag，用于标记当前文件时 Pending 状态。其他 App 通过 MediaStore 查询文件，如果没有设置 setIncludePending 接口，查询不到设置为 Pending 状态的文件，这就给 App 专享访问此文件。在一些情况下使用，例如在下载的时候：下载中，文件是 Pending 状态下载完成，文件 Pending 状态置为0。

![](https://note.youdao.com/src/F90B0173879E421FBAE1A9F701C927C5#id=KBj7x&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
2. 通过 `MediaStore.setRequireOriginal` 返回新 Uri<br>![](https://note.youdao.com/src/EA684E68CEEF4B87811A03E290D7904A#id=ktoEg&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

#### SAF

SAF，即 `Storage Access Framework`，通过选择不同的 DocumentsProvider，提供给用户打开、浏览文件。<br>![image.png](https://cdn.nlark.com/yuque/0/2023/png/694278/1687785957551-015a44e1-179e-4096-aa7a-b2adad6d42e0.png#averageHue=%23f9f2e3&clientId=uc4a2b268-dea0-4&from=paste&height=241&id=ub1705c85&originHeight=482&originWidth=784&originalType=binary&ratio=2&rotation=0&showTitle=false&size=117019&status=done&style=none&taskId=u1cc8d87b-f521-43b9-a5aa-9e509d482be&title=&width=392)<br><https://developer.android.com/guide/topics/providers/document-provider>
...
![](https://note.youdao.com/src/85E08BF65F3043AFAABA2EB054A1D632#id=JcBMj&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

###### 选择目录

![](https://note.youdao.com/src/051E262116864917B44ED2A47293F2E3#id=BuV2z&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

> 文件管理程序，清理程序，可以通过这个方法获取对应目录以及子目录的全部管理权限。

###### 新建文件

![](https://note.youdao.com/src/FE148A3C7C254D54A3AF47EC456423DE#id=Mh7es&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](https://note.youdao.com/src/3C63A3CD89174252A1227ABA14AC47E1#id=BbZqY&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
RequestLegacyExternalStorage 是 Android 10 引入的，preserveLegacyExternalStorage 是 Android 11引入的。

1. RequestLegacyExternalStorage=true 让 targetSdkVersion 是 29（适配了 Android 10）的 app 无论是新安装还是覆盖安装在 Android 10 系统上也继续访问旧的存储模型，requestLegacyExternalStorage 在 Android11上的手机失效。
