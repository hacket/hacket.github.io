...
如果每次查看反编译后的字节码都使用javap命令的话，好非常繁琐。这里推荐一个Idea插件：`jclasslib`。使用效果如图所示，代码编译后在菜单栏`View→Show Bytecode With jclasslib`，可以很直观地看到当前字节码文件的类信息、常量池、方法区等信息。<br />![image.png](https://cdn.nlark.com/yuque/0/2023/png/694278/1693624611900-57544766-20aa-4499-bb5b-460a9c759822.png#averageHue=%233d4349&clientId=u20281b9d-25a6-4&from=paste&height=291&id=u19db1dee&originHeight=582&originWidth=1232&originalType=binary&ratio=2&rotation=0&showTitle=false&size=96070&status=done&style=none&taskId=u3f94d731-8dbe-4f0e-a57a-8b43d9da84c&title=&width=616)

#### ASM Bytecode Viewer插件

查看class文件对应的字节码<br />使用：找到目标.class文件→右键→选择ASM Bytecode Viewer<br />![image.png](https://cdn.nlark.com/yuque/0/2023/png/694278/1693626309539-2c8026d0-c661-4e2b-8d62-5a5faa1b7f39.png#averageHue=%23a36430&clientId=u8d7f911c-3d9b-4&from=paste&height=440&id=u481d2fe7&originHeight=1280&originWidth=1054&originalType=binary&ratio=2&rotation=0&showTitle=false&size=178408&status=done&style=none&taskId=uac2400e2-447c-47c7-bd74-8b0d1d2e64d&title=&width=362)
...
![image.png](https://cdn.nlark.com/yuque/0/2023/png/694278/1693624901762-0f28c3cc-11fc-4da0-b587-c44f6477f341.png#clientId=u20281b9d-25a6-4&from=paste&height=2180&id=ubd5ceb89&originHeight=4359&originWidth=700&originalType=binary&ratio=2&rotation=0&showTitle=false&size=1531532&status=done&style=none&taskId=u6502655a-91cc-4169-ab2c-abdcf7ff201&title=&width=350)
